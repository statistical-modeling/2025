...
*Which reads:*
The biomass per basal area across plots $Y(i)$ follows a normal distribution with expected value $\mu$ that is a linear function of the coarse woody productivity of each plot, with a standard deviation $\sigma$ following a normal distribution
