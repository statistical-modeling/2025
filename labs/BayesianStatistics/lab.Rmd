...
Several methods exist to implement this idea, such as the LASSO, Ridge regression, and Elastic Net. Here, we will use a Bayesian version, called the _horseshoe prior_. This prior is defined as:
...
\[
  ...
  \beta_j &\sim Normal(0, \lambda_j \tau) \\
...
m_horseshoe = stan_glm(y ~ x1 + x2 + z1 + z2 + z3, data = d, 
          ...
          prior_intercept = normal(0, 1), chains = 4, cores = 4, iter = 2000)
