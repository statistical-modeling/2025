...
```{r slides}
#| eval: true
xaringanExtra::embed_xaringan("03_linear_models/slides.html")
```

# Lab

[Simple linear regression Lab](03_linear_models/lab.html)

[Multiple linear regression Lab](03_linear_models/lab2.html)
