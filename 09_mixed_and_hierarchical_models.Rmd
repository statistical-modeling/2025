...
```{r slides}
#| eval: true
xaringanExtra::embed_xaringan("08_mixed_models/slides.html")
```

[Open slides in new window](08_mixed_models/slides.html)

[Slides PDF](08_mixed_models/MixedModels.pdf)
