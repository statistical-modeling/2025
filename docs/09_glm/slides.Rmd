...
style_duo_accent(
  ...
  text_bold_color = "#3F0D6B",
  header_font_google = google_font("Playfair Display"),
  text_font_google = google_font("Playfair Display", "300", "300i"),
