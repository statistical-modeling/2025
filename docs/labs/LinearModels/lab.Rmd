...
# The summary function provides a lot of information about the model, including estimates, standard errors, p-values for the coefficients, and residual standard deviation (sigma)
summary(mod_ols)
```
...
ggplot(data, aes(x, y)) + 
  geom_point() +
  geom_abline(intercept = coef(mod_ols)[1], slope = coef(mod_ols)[2], color = "red") +
  geom_abline(intercept = coef(mod_bayesian)[1], slope = coef(mod_bayesian)[2], color = "blue") + theme_bw()
```
