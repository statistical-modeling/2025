...
- They expect a positive relationship between adjustment behavior and interespecific 
competition
...
The more intense the __interespecific competition__, the more the antlion needs to
...
The more intense the __interespecific competition__, the higher the ratio
...
---
## Understanding the interespecific competition
...
--
1. $\mu_i = \alpha + \beta*Environment + \beta*C$


--
2. $\mu_i = \alpha_{Env} + \beta*Environment + \beta*C$
...
$$\mu_i = \alpha + \beta*Environment + \beta*C$$
...
$$\mu_i = \alpha_{Env} + \beta*Environment + \beta*C$$
...
--
- **LOO-CV**: Best for **prediction**, but computationally expensive  
